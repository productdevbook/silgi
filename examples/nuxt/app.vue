...
<template>
  <main style="max-width: 480px; margin: 3rem auto; font-family: system-ui; padding: 0 1rem">
    ...
    <p style="color: #888; margin-bottom: 1.5rem; font-size: 0.875rem">
      Type-safe RPC with Silgi
    </p>
    ...
    >
      ...
      <button
        type="submit"
        style="padding: 0.5rem 1rem; background: #111; color: #fff; border: none; border-radius: 6px; cursor: pointer; font-size: 0.875rem"
      >
        Add
      </button>
    </form>
    ...
    <!-- Loading -->
    <p v-if="loading" style="color: #888">
      Loading...
    </p>
    ...
    <p
      v-if="todos.length > 0"
      style="margin-top: 1rem; font-size: 0.75rem; color: #888"
    >
