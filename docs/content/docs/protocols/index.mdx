---
title: Protocols
description: Katman supports three wire formats — JSON, MessagePack, and devalue — plus WebSocket for persistent connections.
---
...
<Callout type="info">
You can also use these formats over [WebSocket](/docs/protocols/websocket). Pass `binary: true` to `attachWebSocket` for MessagePack over WebSocket.
</Callout>
...
<Cards>
  <Card title="MessagePack" description="Binary protocol for smaller payloads and native Date support." href="/docs/protocols/msgpack" />
  ...
  <Card title="WebSocket" description="Bidirectional RPC over a persistent connection. Ideal for real-time and subscriptions." href="/docs/protocols/websocket" />
</Cards>
