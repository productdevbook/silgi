...
| --------- | -------------- | ---------- | ---------- | ------ |
| Silgi     | **254,449**    | **0.77s**  | **1.19s**  | 369 MB |
| oRPC      | 896,796        | 1.09s      | 1.38s      | 475 MB |
| tRPC      | 1,260,273      | 1.96s      | 2.22s      | 543 MB |

Silgi produces **3.5× fewer type instantiations** than oRPC and **5× fewer** than tRPC. In practice this means faster editor responsiveness and shorter CI type-check runs as your router grows.
