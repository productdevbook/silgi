...
description: Call Katman procedures as React Server Actions — type-safe [error, data] tuples instead of try/catch.
---
...
You need a Katman router defined on the server. If you haven't set one up yet, see the [Getting Started](/docs/getting-started) guide.
