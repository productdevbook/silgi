---
title: SolidStart
description: Use Katman with SolidStart API routes.
---

[SolidStart](https://start.solidjs.com) uses file-based API routes powered by Nitro. Katman integrates via a catch-all endpoint.
