...
<Callout>
For local development, generate self-signed certificates with [mkcert](https://github.com/FiloSottile/mkcert). For production, use certificates from your hosting provider or Let's Encrypt.
</Callout>
...
<Callout type="info">
Hooks are for side effects like logging and metrics. They don't modify the request or response. For that, use [guards and wraps](/docs/middleware).
</Callout>
