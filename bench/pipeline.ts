...
const v1_noMw = v1Compile([], async ({ input }) => ({ result: input }), undefined, undefined, {
...
const v1_3sync = v1Compile(v1_3syncMw, async ({ context }) => context, undefined, undefined, {
  inputValidationIndex: 0,
  outputValidationIndex: 0,
})
...
const v1_5mix = v1Compile(v1_5mixMw, async ({ context }) => context, undefined, undefined, {
  inputValidationIndex: 0,
  outputValidationIndex: 0,
})
