          ...
          ?.map((option, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "group hover:bg-accent/50 relative flex items-center space-x-2 rtl:space-x-reverse px-2 py-2.5",
              ...
              >
                ...
                >
                  ...
                  <span className="ms-auto flex items-center justify-center font-mono text-xs">
                    {isLoading ? (
                  ...
                  <button
                    ...
                    className={cn(
                      "text-muted-foreground hover:text-foreground absolute inset-y-0 end-0 hidden font-normal backdrop-blur-xs group-hover:block",
