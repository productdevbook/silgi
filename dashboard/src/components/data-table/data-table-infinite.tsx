  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "border-border flex max-w-full flex-1 flex-col sm:border-s",
            // Chrome issue
                ...
                {table.getHeaderGroups().map((headerGroup) => (
                  <TableRow
                    ...
                    className={cn(
                      ...
                      "*:border-t [&>:not(:last-child)]:border-e",
                    )}
                  >
                        ...
                        >
                          ...
                          {header.column.getCanResize() && (
                            <div
                              ...
                              className={cn(
                                "user-select-none absolute top-0 -end-2 z-10 flex h-full w-4 cursor-col-resize touch-none justify-center",
                                "before:bg-border before:absolute before:inset-y-0 before:w-px before:translate-x-px rtl:before:-translate-x-px",
                              )}
                            />
                          )}
                        </TableHead>
