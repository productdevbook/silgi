...
export function DataTableViewOptions() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger render={<Button variant="outline" size="icon" role="combobox" aria-expanded={open} className="shadow-none" />}><Settings2 className="h-4 w-4" /><span className="sr-only">View</span></PopoverTrigger>
                ...
                {sortedColumns
                  ...
                  .map((column) => (
                    <SortableItem key={column.id} value={column.id} render={<CommandItem value={column.id} onSelect={() =>
                                              ...
                                              } className={"capitalize"} disabled={drag} />}><div
                                                className={cn(
                                              ...
                                              >
                                                ...
                                                <SortableDragHandle
                                                  variant="ghost"
                                                  size="icon"
                                                  className="text-muted-foreground hover:text-foreground focus:bg-muted focus:text-foreground ms-auto size-5"
                                                >
                                                  <GripVertical
                                                    className="size-4"
                                                    aria-hidden="true"
